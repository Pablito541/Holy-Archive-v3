...
import { TrendingUp, Package, Sparkles, ArrowRight, LogOut, User, Moon, Sun, Monitor, Settings } from 'lucide-react';
                ...
                <PullToRefresh onRefresh={onRefresh}>
                    <div className="px-6 pt-6 pb-6 max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <Card className="lg:col-span-2 p-6 sm:p-8 bg-[linear-gradient(135deg,_#3f3f46_0%,_#2d2d32_18%,_#1e1e22_35%,_#121214_52%,_#07070a_70%,_#000000_100%)] text-white rounded-[2rem] shadow-2xl shadow-stone-900/20 relative overflow-hidden !border-0">
                            ...
                            {/* Stock Overview */}
                            <Card
                                className="p-6 sm:p-8 bg-[linear-gradient(135deg,_#3f3f46_0%,_#2d2d32_18%,_#1e1e22_35%,_#121214_52%,_#07070a_70%,_#000000_100%)] text-white rounded-[2rem] shadow-2xl shadow-stone-900/20 relative overflow-hidden !border-0 flex flex-col cursor-pointer"
