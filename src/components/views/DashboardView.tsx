                ...
                <PullToRefresh onRefresh={onRefresh}>
                    <div className="px-6 pt-6 pb-6 max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <Card className="lg:col-span-2 p-6 sm:p-8 bg-[linear-gradient(135deg,_#18181b_0%,_#111113_30%,_#070709_60%,_#000000_100%)] text-white rounded-[2rem] shadow-2xl shadow-stone-900/20 relative overflow-hidden !border-0">
                            ...
                            {/* Stock Overview */}
                            <Card
                                className="p-6 sm:p-8 bg-[linear-gradient(135deg,_#18181b_0%,_#111113_30%,_#070709_60%,_#000000_100%)] text-white rounded-[2rem] shadow-2xl shadow-stone-900/20 relative overflow-hidden !border-0 flex flex-col cursor-pointer"
