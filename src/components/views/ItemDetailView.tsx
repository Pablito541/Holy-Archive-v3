...
import { X, ArrowLeft, ZoomIn, Trash2, ShoppingBag, Edit2, Share2, RotateCcw, ShieldCheck } from 'lucide-react';
...
export const ItemDetailView = ({ item, onBack, onSell, onDelete, onCancelSale, onEdit }: {
    item: Item,
    onBack: () => void,
    onSell: () => void,
    onDelete: () => void,
